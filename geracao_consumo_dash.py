...
for l in content:                                                             #for lê todas as linhas da lista
    ...
    if ls[1] == "Nordeste":                                                   #Condiciona que se o elemento 1 da lista for igual à "Norte" prossigo
...
for l in content:                                                             #for lê todas as linhas da lista
    ...
    if ls[1] == "Centro-Oeste":                                               #Condiciona que se o elemento 1 da lista for igual à "Norte" prossigo
...
for l in content:                                                             #for lê todas as linhas da lista
    ...
    if ls[1] == "Sudeste":                                                    #Condiciona que se o elemento 1 da lista for igual à "Norte" prossigo
...
for l in content:                                                             #for lê todas as linhas da lista
    ...
    if ls[1] == "Sul":                                                        #Condiciona que se o elemento 1 da lista for igual à "Norte" prossigo
